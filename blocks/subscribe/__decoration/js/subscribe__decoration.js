document.addEventListener('DOMContentLoaded', function(e) {
	let chili_1 = document.querySelector('.subscribe__decoration_chili-1');
    let chili_2 = document.querySelector('.subscribe__decoration_chili-2');
    let chili_3 = document.querySelector('.subscribe__decoration_chili-3');
    let chesnok = document.querySelector('.subscribe__decoration_chesnok-1');
    let onion = document.querySelector('.subscribe__decoration_onion-1');
    let perech_1 = document.querySelector('.subscribe__decoration_perech-1');
    let perech_2 = document.querySelector('.subscribe__decoration_perech-2');
    let tomat = document.querySelector('.subscribe__decoration_tomat-1');
    let vetka = document.querySelector('.subscribe__decoration_vetka-1');
